# Benchmark Stability Probe: env21
...
## Summary
- Case ID: `env21_ecs_passedtoservice_scoped_away_nonvalidated`
- Requested runs: `3`
- Run records: `3`
...
## Runs
- Run 1: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env21/archives/env21-20260506T184634Z-stability-01`
- Run 2: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env21/archives/env21-20260506T184736Z-stability-02`
- Run 3: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env21/archives/env21-20260506T184837Z-stability-03`
