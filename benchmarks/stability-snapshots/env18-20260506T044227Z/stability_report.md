# Benchmark Stability Probe: env18
...
## Summary
- Case ID: `env18_lambda_passrole_validated`
- Requested runs: `3`
- Run records: `3`
...
## Runs
- Run 1: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env18/archives/env18-20260506T044021Z-stability-01`
- Run 2: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env18/archives/env18-20260506T044122Z-stability-02`
- Run 3: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env18/archives/env18-20260506T044227Z-stability-03`
