# Benchmark Stability Probe: env19
...
## Summary
- Case ID: `env19_passedtoservice_scoped_away_nonvalidated`
- Requested runs: `3`
- Run records: `3`
...
## Runs
- Run 1: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env19/archives/env19-20260506T151428Z-stability-01`
- Run 2: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env19/archives/env19-20260506T151528Z-stability-02`
- Run 3: semantic=`pass`, runner_rc=`0`, evaluation_rc=`0`, scenario_validation=`pass`, archive=`/tmp/iamscope-stability-env19/archives/env19-20260506T151628Z-stability-03`
