...
- `env25_s3_resource_policy_allow_scoped_away_nonvalidated` / `iamscope-benchmark-env25-20260508T210637Z`: score_passed=`true`, promotion_blocked=`false`, artifact_sufficient=`true`, human_review_required=`true`, defect_classes=none
- `env26_multihop_chain_validated_admin` / `iamscope-benchmark-env26-20260509T012216Z`: score_passed=`true`, promotion_blocked=`false`, artifact_sufficient=`true`, human_review_required=`true`, defect_classes=none
- `env27_multihop_trust_scoped_away_nonvalidated` / `iamscope-benchmark-env27-20260509T212354Z`: score_passed=`true`, promotion_blocked=`false`, artifact_sufficient=`true`, human_review_required=`true`, defect_classes=none
