...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/env11-ar-output}"
...
BROAD_CONDITIONED_ADMIN_ARN=$(terraform output -raw broad_conditioned_admin_arn)
ROOT_ARN=$(terraform output -raw root_arn)
ACCOUNT_ID=$(terraform output -raw account_id)

echo ""
echo "Resources deployed:"
echo "  alice_arn                  : $ALICE_ARN"
echo "  broad_conditioned_admin_arn: $BROAD_CONDITIONED_ADMIN_ARN"
echo "  root_arn                   : $ROOT_ARN"
