...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/env19-passrole-scoped-away-output}"
...
LAMBDA_ADMIN_ROLE_ARN=$(terraform output -raw lambda_admin_role_arn)
...
echo "  lambda_admin_role_arn : $LAMBDA_ADMIN_ROLE_ARN"
