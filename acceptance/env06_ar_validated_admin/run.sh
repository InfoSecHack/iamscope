#!/usr/bin/env bash
# Env 6 acceptance test - positive validated admin_reachability.
#
# Usage: bash acceptance/env06_ar_validated_admin/run.sh
#
# Prerequisites:
...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/env06-ar-output}"
...
echo ""
echo "============================================================"
echo "PASS: all 3 assertions passed - Env 6 positive admin_reachability acceptance PASS"
echo "============================================================"
