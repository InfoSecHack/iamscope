...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/env08-ar-output}"
...
CONDITIONED_ADMIN_ARN=$(terraform output -raw conditioned_admin_arn)
ACCOUNT_ID=$(terraform output -raw account_id)

echo ""
echo "Resources deployed:"
echo "  alice_arn            : $ALICE_ARN"
echo "  conditioned_admin_arn: $CONDITIONED_ADMIN_ARN"
