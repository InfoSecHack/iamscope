...
OUTPUT_DIR="${OUTPUT_DIR:-/tmp/env20-passrole-ecs-output}"
...
ECS_ADMIN_ROLE_ARN=$(terraform output -raw ecs_admin_role_arn)
ECS_TASK_DEFINITION_ARN=$(terraform output -raw ecs_task_definition_arn)
ACCOUNT_ID=$(terraform output -raw account_id)

echo ""
echo "Resources deployed:"
echo "  alice_arn              : $ALICE_ARN"
echo "  ecs_admin_role_arn     : $ECS_ADMIN_ROLE_ARN"
